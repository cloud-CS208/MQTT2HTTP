...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        new_brightness = int(msg.payload.decode('utf-8'))
        print(f"[Subscriber] Received new brightness: {new_brightness}")
...
def publisher_thread():
    ...
    while True:
        payload = json.dumps({"brightness": brightness, "health": "OK"})
...
def subscriber_thread():
    ...
    sub_client.subscribe("/home/subscribe/light")
