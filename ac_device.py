...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        new_temperature = int(msg.payload.decode('utf-8'))
        print(f"[Subscriber] Received new temperature: {new_temperature}")
...
def publisher_thread():
    ...
    while True:
        payload = json.dumps({"temperature": temperature, "health": "OK"})
...
def subscriber_thread():
    ...
    sub_client.subscribe("/home/subscribe/temperature")
